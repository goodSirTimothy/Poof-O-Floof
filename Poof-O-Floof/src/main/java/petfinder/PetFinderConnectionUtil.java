...
public class PetFinderConnectionUtil {
  ...
  private static final String PET_FINDER_API_KEY = System.getenv("PET_FINDER_API_KEY");
  private static final String PET_FINDER_SECRET = System.getenv("PET_FINDER_SECRET");
