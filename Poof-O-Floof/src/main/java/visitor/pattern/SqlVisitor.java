...
public class SqlVisitor {
	...
	private final String SELECT_PHOTO_BY_USERID = SELECT_ALL + "photo WHERE user_id = ?";
	private final String SAVE_USERS = "INSERT INTO users (user_id, current_ip, current_ip_location, display_name, email, secure_key, salt) "
			+ "VALUES(user_id_seq.nextval, ?, ?, ?, ?, ?, ?)";
	private final String SAVE_PHOTO = "INSERT INTO photo (id, photo_id, animal_id, animal_type, full_url, adoption_url) "
