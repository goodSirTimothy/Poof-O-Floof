...
export class MainPhotoComponent implements OnInit {
  ...
  private mainFramePhotoDepot: Array<TestPhotoJSON>;
  // private mainFramePhotoStream: ReplaySubject<TestPhotoJSON>;
  // private mainFramePSCurrentState: BehaviorSubject<PhotoStreamMetaData>;
